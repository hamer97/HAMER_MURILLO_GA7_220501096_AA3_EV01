...
<head>
    ...
    <!-- Scripts -->
    <!-- Carga de archivos CSS y JS utilizando Vite (un entorno de desarrollo para JavaScript) -->
...
<body>
    <div id="app">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        @guest
                            ...
                            @endif
                        @else
                            <!-- Menú desplegable para el nombre del usuario autenticado -->
        ...
        <main class="py-4">
            @yield('content') <!-- Sección para contenido dinámico proporcionado por las vistas -->
        </main>
    </div>
</body>
</html>
